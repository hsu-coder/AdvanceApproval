...
// onChanged: (value) {
//   if (value != null) {
//     final selectedDept = departments.firstWhereOrNull(
//       (dept) => dept.departmentName == value,
//     );

//     if (selectedDept != null) {
//       setState(() {
//         _selectedDepartmentName = selectedDept.departmentName;
//         _selectedDepartmentId = selectedDept.id.toString();
//       });
//     } else {
//       // Optional: Show error if somehow user picks an invalid department
//       ScaffoldMessenger.of(context).showSnackBar(
...
onChanged: (value) {
  if (value != null) {
    final matched = departments.firstWhere(
      (dept) => dept.departmentName == value,
      orElse: () => Department(id: -1, departmentName: '', departmentCode: ''),
    );

    if (matched.id != -1) {
      setState(() {
        _selectedDepartmentName = matched.departmentName;
        _selectedDepartmentId = matched.id.toString();
      });
    } else {
