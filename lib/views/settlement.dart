...
// import 'package:advance_budget_request_system/views/settlementEntry.dart';
...
//   List<SettlementInfo> filteredData = [];
...
//           await ApiService().fetchSettlementData();
//       List<SettlementDetail> settlementDetails =
//           await ApiService().fetchSettlementDetailData();
...
//         filteredData = List.from(settlements);
...
//    void _handlePaymentSettled(CashPayment updatedPayment) {
//     setState(() {
//       final index = cashpayment.indexWhere((p) => p.id == updatedPayment.id);
//       if (index != -1) {
//         cashpayment[index] = updatedPayment;
//       }
//     });
//   }
...
//     setState(() {
//       filteredData = settlement.where((data) {
//         return data.date
...
//     setState(() {
//       List<SettlementInfo> sourceData = settlement;
//       filteredData = sourceData.where((data) {
//         final paymentNo = data.paymentNo.toLowerCase();
//         final withdrawnAmount = data.withdrawnAmount.toString();
//         final settleAmount = data.settleAmount.toString();
//         final refundAmount = data.refundAmount.toString();
//         final String searchLower = query.toLowerCase();

//         return paymentNo.contains(searchLower) ||
//             withdrawnAmount.contains(searchLower) ||
//             settleAmount.contains(searchLower) ||
//             refundAmount.contains(searchLower);
//       }).toList();
//       _updatePagination();
//     });
//   }
...
//             aValue = a.withdrawnAmount;
//             bValue = b.withdrawnAmount;
//             break;
//           case 'SettleAmount':
//             aValue = a.settleAmount;
//             bValue = b.settleAmount;
//             break;
//           case 'RefundAmount':
...
//       startDate = null;
//       endDate = null;
//       filteredData = List.from(settlement);
//       sortColumn = null;
//       sortAscending = true;
//       currentPage = 1;
//       _updatePagination();
...
//   List<SettlementInfo> get paginatedData {
...
//       //Add the data rows
//       for (var settlement in settlement) {
//         csvData.add([
//           DateFormat('yyyy-MM-dd').format(settlement.date),
//           settlement.paymentNo,
//           settlement.requestNo,
//           settlement.withdrawnAmount,
//           settlement.settleAmount,
//           settlement.refundAmount,
//           serializeBudgetDetails(settlement.budgetDetails ?? [])
//         ]);
//       }
...
//       return '${budget.BudgetCode}: ${budget.Description}: ${budget.Amount}';
//     }).join('; ');
//   }
...
//                           padding: const EdgeInsets.all(8.0),
//                           child:
//                               _buildHeaderCell("Settle Amount", "SettleAmount"),
//                         ),
//                         Padding(
//                           padding: const EdgeInsets.all(8.0),
//                           child:
//                               _buildHeaderCell("Refund Amount", "RefundAmount"),
//                         ),
//                         const Padding(
...
//                     Padding(
//                       padding: const EdgeInsets.all(8.0),
//                       child: Text(row.withdrawnAmount.toString()),
//                     ),
//                     Padding(
//                       padding: const EdgeInsets.all(8.0),
//                       child: Text(row.settleAmount.toString()),
//                     ),
//                     Padding(
//                       padding: const EdgeInsets.all(8.0),
//                       child: Text(row.refundAmount.toString()),
//                     ),
...
//                                     builder: (context) =>
//                                         DetailSettlement(settlement: row)));
//                               },
//                               icon: const Icon(
...
// //Detail Settlement
// class DetailSettlement extends StatelessWidget {
//   final SettlementInfo settlement;
//   const DetailSettlement({Key? key, required this.settlement})
//       : super(key: key);
...
//             _buildRow("Payment No", settlement.paymentNo, "Payment Date",
//                 DateFormat('yyyy-MM-dd').format(settlement.date)),
//             const SizedBox(height: 20),
//             _buildRow("Withdrawn Amount", settlement.withdrawnAmount.toString(),
//                 "Settle Amount", settlement.settleAmount.toString()),
//             const SizedBox(height: 20),
//             _buildRow("refund Amount", settlement.refundAmount.toString(),
//                 "Request No", settlement.requestNo),
...
//                         ),
//                       ]),
//                   ...settlement.budgetDetails!.map((budget) {
//                     return TableRow(children: [
//                       Padding(
//                         padding: const EdgeInsets.all(8.0),
...
//                       Padding(
//                         padding: const EdgeInsets.all(8.0),
//                         child: Text(budget.Amount.toString()),
//                       )
//                     ]);
//                   })
//                 ],
